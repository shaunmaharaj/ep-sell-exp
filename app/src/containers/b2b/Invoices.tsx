...
export default class Invoices extends React.Component<{}, InvoicesState> {
  ...
  static renderInvoicesStatus(status) {
    let icon;
  ...
  render() {
    ...
    return (
      <div className="Invoices-component">
          ...
          <div className="b2b-section section-1 invoices">
            <div className="section-header">
              ...
              <div className="section-header-right">
                {Invoices.periodRender(intl.get('last-7-days'))}
              </div>
            </div>
        ...
        <div>
          <div className="b2b-section Invoices">
            <div className="section-header">
              <div className="section-title">{intl.get('Invoices')}</div>
              <div className="section-header-right">
            ...
            <div className="section-content">
              <table className="b2b-table Invoices-table">
                <thead>
                  <tr>
                    ...
                    <th className="quote-request-from">{intl.get('account')}</th>
                    ...
                    .map(quote => (
                      <tr key={quote.id}>
                        ...
                        <td className="quote-status">
                          {Invoices.renderInvoicesStatus(quote.status)}
                        </td>
                        <td className="quote-status">
                          {'•••'}
                        </td>
